import { require_react } from './chunk-32EALFBN.js';
import { require_react_dom } from './chunk-FYGYNQUM.js';
...
async function runServerMiddlewarePipeline(args, handler, errorHandler) {
  ...
  let tuples = matches.flatMap((m) =>
    m.route.unstable_middleware ? m.route.unstable_middleware.map((fn) => [m.route.id, fn]) : [],
  );
...
try {
  if (isBrowser) {
    window.__reactRouterVersion = '7.8.0'; // @ts-expect-error
  }
} catch (e) {}
            ...
            React42.startTransition(() => {
              window.__router._internalSetStateDoNotUseOrYouWillBreakYourApp({
                ...
                errors: rerender.errors
                  ? Object.assign({}, globalVar.__router.state.errors, rerender.errors)
                  : null,
              });
            });
          }
  ...
  return React42.createElement(
    ...
    React42.createElement(
      ...
      React42.createElement(
        ...
        React42.createElement(RouterProvider, { router: router2, flushSync: ReactDOM.flushSync }),
      ),
    ),
  );
}
    ...
    React23.createElement(
      ...
      React23.createElement(
        ...
        React23.createElement(
          RemixErrorBoundary,
          { location: location2 },
          React23.createElement(RouterProvider2, { router }),
        ),
      ),
