...
import { GenIcon } from './chunk-SGLBH52P.js';
...
function IoIosBody(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 512 512' },
    child: [
      { tag: 'ellipse', attr: { cx: '256', cy: '80', rx: '48', ry: '48' }, child: [] },
      {
        tag: 'path',
        attr: {
...
function IoIosCamera(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 512 512' },
    child: [
      { tag: 'circle', attr: { cx: '256', cy: '275', r: '57.5' }, child: [] },
      {
        tag: 'path',
        attr: {
...
function IoIosCash(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'circle', attr: { cx: '256', cy: '206', r: '53' }, child: [] },
    ],
  })(props);
}
...
function IoIosCodeWorking(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'circle', attr: { cx: '256', cy: '256', r: '22' }, child: [] },
      { tag: 'circle', attr: { cx: '192', cy: '256', r: '22' }, child: [] },
      { tag: 'circle', attr: { cx: '320', cy: '256', r: '22' }, child: [] },
    ],
  })(props);
}
...
function IoIosFlashlight(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'circle', attr: { cx: '256', cy: '273', r: '20' }, child: [] },
    ],
  })(props);
}
...
function IoIosList(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 512 512' },
    child: [
      { tag: 'circle', attr: { cx: '92', cy: '256', r: '28' }, child: [] },
      { tag: 'circle', attr: { cx: '92', cy: '132', r: '28' }, child: [] },
      { tag: 'circle', attr: { cx: '92', cy: '380', r: '28' }, child: [] },
      {
        tag: 'path',
        attr: {
...
function IoIosMailUnread(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 512 512' },
    child: [
      { tag: 'circle', attr: { cx: '416', cy: '152', r: '48' }, child: [] },
      {
        tag: 'path',
        attr: {
  ...
  return GenIcon({
    ...
    child: [
      ...
      },
      {
        ...
        attr: {},
        child: [
          { tag: 'circle', attr: { cx: '256', cy: '352', r: '56' }, child: [] },
          {
            tag: 'path',
            attr: {
...
function IoIosNuclear(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'circle', attr: { cx: '256', cy: '256', r: '56' }, child: [] },
    ],
  })(props);
}
...
function IoIosSwitch(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'circle', attr: { cx: '368', cy: '144', r: '42' }, child: [] },
      {
        tag: 'path',
        attr: {
...
function IoIosTrain(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'circle', attr: { cx: '256', cy: '304', r: '30.5' }, child: [] },
    ],
  })(props);
}
...
function IoLogoAngular(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 512 512' },
    child: [
      { tag: 'path', attr: { d: 'M213.573 256h84.846l-42.427-89.356z' }, child: [] },
      {
        tag: 'path',
        attr: {
...
function IoLogoDesignernews(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 512 512' },
    child: [
      { tag: 'path', attr: { d: 'M290.4 145L227 96l63.6 102.2z' }, child: [] },
      {
        tag: 'path',
        attr: {
...
function IoLogoIonic(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'circle', attr: { cx: '392.1', cy: '126.4', r: '43.2' }, child: [] },
      {
        tag: 'path',
        attr: {
...
function IoLogoNoSmoking(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 512 512' },
    child: [
      { tag: 'path', attr: { d: 'M360 256h16v48h-16zM112 304h129.6l-48-48H112z' }, child: [] },
      {
        tag: 'path',
        attr: {
...
function IoLogoReddit(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 512 512' },
    child: [
      { tag: 'circle', attr: { cx: '322.3', cy: '288.4', r: '31.8' }, child: [] },
      { tag: 'circle', attr: { cx: '190.3', cy: '288.4', r: '31.8' }, child: [] },
      {
        tag: 'path',
        attr: {
...
function IoLogoTwitch(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M320 143h48v129h-48zM208 143h48v129h-48z' }, child: [] },
    ],
  })(props);
}
...
function IoMdArrowDropdown(props) {
  return GenIcon({
    tag: 'svg',
    attr: { viewBox: '0 0 512 512' },
    child: [{ tag: 'path', attr: { d: 'M128 192l128 128 128-128z' }, child: [] }],
  })(props);
}
...
function IoMdArrowDropleft(props) {
  return GenIcon({
    tag: 'svg',
    attr: { viewBox: '0 0 512 512' },
    child: [{ tag: 'path', attr: { d: 'M320 128L192 256l128 128z' }, child: [] }],
  })(props);
}
...
function IoMdArrowDropright(props) {
  return GenIcon({
    tag: 'svg',
    attr: { viewBox: '0 0 512 512' },
    child: [{ tag: 'path', attr: { d: 'M192 128l128 128-128 128z' }, child: [] }],
  })(props);
}
...
function IoMdArrowDropup(props) {
  return GenIcon({
    tag: 'svg',
    attr: { viewBox: '0 0 512 512' },
    child: [{ tag: 'path', attr: { d: 'M128 320l128-128 128 128z' }, child: [] }],
  })(props);
}
...
function IoMdCamera(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 512 512' },
    child: [
      { tag: 'circle', attr: { cx: '256', cy: '280', r: '63' }, child: [] },
      {
        tag: 'path',
        attr: {
...
function IoMdCellular(props) {
  return GenIcon({
    tag: 'svg',
    attr: { viewBox: '0 0 512 512' },
    child: [{ tag: 'path', attr: { d: 'M64 448h384V64L64 448z' }, child: [] }],
  })(props);
}
...
function IoMdCloudy(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 512 512' },
    child: [
      { tag: 'path', attr: { d: 'M123.4 183c.4-.1.8-.1 1.2-.2-.5.1-.8.2-1.2.2z' }, child: [] },
      {
        tag: 'path',
        attr: {
...
function IoMdEasel(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 512 512' },
    child: [
      { tag: 'path', attr: { d: 'M128 176h256v128H128z' }, child: [] },
      {
        tag: 'path',
        attr: {
...
function IoMdFlash(props) {
  return GenIcon({
    tag: 'svg',
    attr: { viewBox: '0 0 512 512' },
    child: [{ tag: 'path', attr: { d: 'M160 48v224h64v192l128-256h-64l64-160H160z' }, child: [] }],
  })(props);
}
...
function IoMdInformationCircleOutline(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M277 360h-42V235h42v125zm0-166h-42v-42h42v42z' }, child: [] },
    ],
  })(props);
}
...
function IoMdInformation(props) {
  return GenIcon({
    tag: 'svg',
    attr: { viewBox: '0 0 512 512' },
    child: [{ tag: 'path', attr: { d: 'M232 235h48v137h-48zM232 140h48v48h-48z' }, child: [] }],
  })(props);
}
  ...
  return GenIcon({
    ...
    child: [
      ...
      },
      {
        tag: 'g',
        attr: {},
        child: [{ tag: 'path', attr: { d: 'M80 376h288v48H80z' }, child: [] }],
      },
    ],
  })(props);
}
...
function IoMdMedal(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 512 512' },
    child: [
      { tag: 'path', attr: { d: 'M273.5 152.1H48l54.1-103.9h240.7z' }, child: [] },
      { tag: 'circle', attr: { cx: '256.2', cy: '377.2', r: '86.6' }, child: [] },
      {
        tag: 'path',
        attr: {
...
function IoMdPlay(props) {
  return GenIcon({
    tag: 'svg',
    attr: { viewBox: '0 0 512 512' },
    child: [{ tag: 'path', attr: { d: 'M96 52v408l320-204L96 52z' }, child: [] }],
  })(props);
}
...
function IoMdRemoveCircleOutline(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M363 277H149v-42h214v42z' }, child: [] },
    ],
  })(props);
}
...
function IoMdRemove(props) {
  return GenIcon({
    tag: 'svg',
    attr: { viewBox: '0 0 512 512' },
    child: [{ tag: 'path', attr: { d: 'M96 235h320v42H96z' }, child: [] }],
  })(props);
}
...
function IoMdSend(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 512 512' },
    child: [
      { tag: 'path', attr: { d: 'M48 448l416-192L48 64v149.333L346 256 48 298.667z' }, child: [] },
    ],
  })(props);
}
...
function IoMdSkipBackward(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 512 512' },
    child: [
      { tag: 'path', attr: { d: 'M170.7 256L448 448V64L170.7 256zM64 64h64v384H64z' }, child: [] },
    ],
  })(props);
}
function IoMdSkipForward(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 512 512' },
    child: [
      { tag: 'path', attr: { d: 'M64 64v384l277.3-192L64 64zM384 64h64v384h-64z' }, child: [] },
    ],
  })(props);
}
...
function IoMdStopwatch(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 512 512' },
    child: [
      { tag: 'path', attr: { d: 'M232 306.667h48V176h-48v130.667z' }, child: [] },
      {
        tag: 'path',
        attr: {
