...
export default function FavQuestModal({
  ...
  const start = safeDate((quest as any).startAt ?? null);
  const end = safeDate((quest as any).endAt ?? null);
        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="p-6 sm:p-8 relative">
            ...
            <div className="mb-4">
              ...
              {quest.venueName ? <div className="mt-1 text-sm text-gray-500">{quest.venueName}</div> : null}
            </div>
            ...
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                ...
                <div className="mt-4">
                  ...
                  <div className="text-base font-medium">
                    {start ? <span>Start: {start}</span> : <span>Start: —</span>}
                    {end ? <span className="ml-3">End: {end}</span> : null}
                  </div>
                </div>
              </div>
